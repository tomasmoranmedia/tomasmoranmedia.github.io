  ...
  return (
    <main className="television-page social-page">
      <WorkPageHero
        ...
        title="Social Media"
        description="I edit and create bilingual social media content for NNN Sports and News, WNUR Sports, Obscure Ballers and my own accounts. I was also covered the Chicago Fire's 2025 MLS playoff run on socials with 98.3FM The Life."
