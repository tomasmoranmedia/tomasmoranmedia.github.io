    ...
    <main>
      <div className="work-container">
        ...
        <div className="work-featured-cards">
          <a className="work-card" href="#television" onClick={handleCardClick}>
          ...
          <a className="work-card" href="#radio" onClick={handleCardClick}>
          ...
          <a className="work-card" href="#documentary" onClick={handleCardClick}>
          ...
          <a className="work-card" href="#print" onClick={handleCardClick}>
          ...
          <a className="work-card" href="#social-media" onClick={handleCardClick}>
